 ...
 */
public class SimpleLeLoadingViewHardware extends View {
    ...
    public SimpleLeLoadingViewHardware(Context context) {
        this(context, null);
    }

    public SimpleLeLoadingViewHardware(Context context, AttributeSet attrs) {
        super(context, attrs);
